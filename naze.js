...
module.exports = naze = async (naze, m, chatUpdate, store) => {
    try {
		...
		const fkontak = { key: {participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: `status@broadcast` } : {}) }, message: { 'contactMessage': { 'displayName': 'Nakano Rizal', 'vcard': `BEGIN:VCARD\nVERSION:3.0\nN:XL;Nakano Rizal,;;;\nFN:Nakano Rizal\nitem1.TEL;waid=6283199544825:6283199544825\nitem1.X-ABLabel:Ponsel\nEND:VCARD`, 'jpegThumbnail': thumb, thumbnail: thumb,sendEphemeral: true}}}
...
╰──❍`
                ...
                naze.sendListMsg(m.chat, kukiw, nyoutube, `*Hello Kak ${pushname}*!`, `Pilih Menu`, sections, m, {mentions: ments, quoted: fkontak})
            }
            break
            case 'sumi': {
            let ownernya = ownernomer + '@s.whatsapp.net'
