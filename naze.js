...
module.exports = naze = async (naze, m, chatUpdate, store) => {
    try {
		...
		const fkontak = { key: {participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: `status@broadcast` } : {}) }, message: { 'contactMessage': { 'displayName': 'Summ..', 'vcard': `BEGIN:VCARD\nVERSION:3.0\nN:XL;Summ..,;;;\nFN:Summ..\nitem1.TEL;waid=62882006679823:62882006679823\nitem1.X-ABLabel:Ponsel\nEND:VCARD`, 'jpegThumbnail': thumb, thumbnail: thumb,sendEphemeral: true}}}
...
*Silahkan* @${m.mentionedJid[0].split`@`[0]} *untuk ketik terima/tolak*`
	    ...
	    case 'donasi': case 'sewabot': case 'sewa': case 'buypremium': case 'donate': {
                naze.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/2835076b6623102482f9a.png' }, caption: `${ucapanWaktu} *${m.pushName}* 👋\n\nJika Ingin Berdonasi Silahkan Scan Gambar Diatas\n\n_Atau Klik Link Dibawah Ini_\nhttps://saweria.co/rizalnugroho\n\nBerapapun Donasi Kalian Akan Sangat Berarti😇\n\n_Terima kasih^^_` }, { quoted: m })
            }
            break
            case 'sc': {
...
-Creator :  @${ownernya.split('@')[0]}\n-Lu : @${me.split('@')[0]}\n-Powered  : @${ini_mark.split('@')[0]}\n- :  @${qontak.split('@')[0]}\n- :  @${dana.split('@')[0]}\n- :  @${shopeeotp.split('@')[0]}\n- :  @${shopee.split('@')[0]}\n- :  @${tokopedia.split('@')[0]}\n- :  @${smartfrend.split('@')[0]}\n- :  @${getcontact.split('@')[0]}\n- :  @${facebook.split('@')[0]}\n- :  @${pasarpolis.split('@')[0]}\n- :  @${getcontact.split('@')[0]}\n- :  @${kominfo.split('@')[0]}\n- :  @${alfamart.split('@')[0]}`
            ...
            let ownernya = ownernomer + '@s.whatsapp.net'
            let me = m.sender
            let jawab = `*${ucapanWaktu}* ${groupMetadata}
╭──❍「 𝙄𝙉𝙁𝙊 𝙐𝙎𝙀𝙍 」❍
├ *Nama* : ${pushname}
├ *Number* : @${me.split('@')[0]}
├ *Premium* : ${isPremium ? '✅' : `❌`}
...
╰──❍`
            ...
            break
            case 'simplemenu': case 'sslist': case 'shelp': {
            let ownernya = ownernomer + '@s.whatsapp.net'
            let me = m.sender
            let ments = [ownernya, me, ini_mark]
            let kukiw = `*${ucapanWaktu}* ${groupName}
╭──❍「 𝙄𝙉𝙁𝙊 𝙐𝙎𝙀𝙍 」❍
├ *Nama* : ${pushname}
├ *Number* : ${me.split('@')[0]}
├ *Premium* : ${isPremium ? '✅' : `❌`}
...
╰──❍`
                ...
                naze.sendListMsg(m.chat, kukiw, nyoutube, `*Hello Kak ${pushname}*!`, `Pilih Menu`, sections, ``, {quoted: fkontak})
            }
            break
            case 'sumibotz': {
